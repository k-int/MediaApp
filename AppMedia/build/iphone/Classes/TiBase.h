...
// in simulator we redefine to format for AppMedia Developer console
...
{\
	NSString * exceptionName = [@"org.appmedia." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.appmedia";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIAppMediaNativeItemNone = -1, 
	UIAppMediaNativeItemSpinner = -2,
	UIAppMediaNativeItemProgressBar = -3,
	
	UIAppMediaNativeItemSlider = -4,
	UIAppMediaNativeItemSwitch = -5,
	UIAppMediaNativeItemMultiButton = -6,
	UIAppMediaNativeItemSegmented = -7,
	
	UIAppMediaNativeItemTextView = -8,
	UIAppMediaNativeItemTextField = -9,
	UIAppMediaNativeItemSearchBar = -10,
	
	UIAppMediaNativeItemPicker = -11,
	UIAppMediaNativeItemDatePicker = -12,
	
	UIAppMediaNativeItemInfoLight = -13,
	UIAppMediaNativeItemInfoDark = -14,
	
	UIAppMediaNativeItemDisclosure = -15,
	
	UIAppMediaNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AppMedia instances of
