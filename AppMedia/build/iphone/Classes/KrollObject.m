 ...
 * Copyright (c) 2009-2011 by AppMedia, Inc. All Rights Reserved.
...
//@interface AppMediaObject : NSObject
//@end

@interface AppMediaObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AppMediaObject class]])
		{
			for (NSString *key in [[(AppMediaObject*)o modules] allKeys])
			{
